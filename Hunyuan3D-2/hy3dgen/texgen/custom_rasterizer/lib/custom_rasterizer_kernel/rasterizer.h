...
#ifdef __CUDACC__
// NVCC (CUDA) compiles this: use lightweight headers only —
// avoids the C2872 'std' bug in torch/csrc/dynamo/compiled_autograd.h on MSVC
#include <ATen/ATen.h>
#include <torch/types.h>
#else
// regular MSVC C++ path: full extension header (needed for pybind)
